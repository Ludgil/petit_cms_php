      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
            ...
            $element_text = ['All Posts', 'Active Post','Drafts Posts' , 'Categories', 'Users', 'Subscribers', 'Comments','Pending Comments'];
            $element_count = [$post_count,$post_published_count ,$post_draft_count ,$category_count, $user_count,$subscriber_count, $comment_count, $unapproved_comments_count];
